...
import './Admin/AdminSettings.css'; // Reusing the premium settings styles
...
const StudentSettings = () => {
  ...
  const toggleVisibility = (setter, currentVal) => setter(!currentVal);

  return (
    <div className="settings-wrapper">
      <div className="settings-header">
        <h2>Security Settings</h2>
        <p>Manage your student portal access and credentials</p>
      </div>
      ...
      <div className="settings-card">
        ...
        <form onSubmit={handleChangePassword}>
          <div className="settings-form-group">
            <label>Current Password (or DOB if unchanged)</label>
