...
const CoachesSection = () => {
  ...
  const generateChessAvatar = (name = 'Coach', piece = '♔') => {
    const initials = (name || '').split(' ').filter(n => n.length > 0).map(n => n[0]).join('');
                ...
                <div className="modal-badges">
                  ...
                  <div className="modal-rating-badge">
                    ...
                    <div>
                      ...
                      <div className="rating-value">{(selectedCoach.rating || '').includes(': ') ? selectedCoach.rating.split(': ')[1] : (selectedCoach.rating || 'N/A')}</div>
                    </div>
                  </div>
                </div>
              </div>
